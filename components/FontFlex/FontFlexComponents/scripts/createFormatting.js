function addH1() {
  const textarea = document.getElementById('project-content'); // Change 'test-textarea' to the ID of the textarea (or other elements) that you want to have FontFlex to be working on.
